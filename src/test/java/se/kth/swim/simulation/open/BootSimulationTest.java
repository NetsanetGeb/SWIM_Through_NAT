 ...
 */
public class BootSimulationTest {
    ...
    public static void main(String[] args) {
        ...
        long seedSim = 123; 
         ...
         /**
         * Tests Only OPEN Nodes by varying 
        ...
        */
        ...
        // LauncherComp.scenario = SwimScenario.simpleBoot(seedSim, 100, 10, 4, ENABLE_NAT, 1);
        // LauncherComp.scenario = SwimScenario.simpleBoot(seedSim, 100, 20, 4, ENABLE_NAT, 1);
        // LauncherComp.scenario = SwimScenario.simpleBoot(seedSim, 100, 50, 4, ENABLE_NAT, 1);
        // LauncherComp.scenario = SwimScenario.simpleBoot(seedSim, 100, 100, 4, ENABLE_NAT, 1);
        // LauncherComp.scenario = SwimScenario.simpleBoot(seedSim, 200, 100, 4, ENABLE_NAT, 1);
